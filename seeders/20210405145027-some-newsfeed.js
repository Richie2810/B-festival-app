  ...
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert(
      ...
      [
        {
          title: "We got RHCP's",
          description: "somehow we got RHCPs to play at our festival... wow, chekc out the link to know more about them",
        ...
        {
          title: "Wear a mask!",
          description: "lets stay safe and wear a mask during the pandemic!",
        ...
        },
        {
          ...
          description: "Leave a comment of you fav band",
